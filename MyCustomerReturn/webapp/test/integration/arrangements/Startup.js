sap.ui.define([
	"sap/ui/test/Opa5",
	"cn/bosch/MyCustomerReturn/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("cn.bosch.MyCustomerReturn.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "cn.bosch.MyCustomerReturn",
					async: true
				},
				hash: oOptions.hash,
